...
fwrite($fphtml,"</th>\n");
fwrite($fphtml,"<th>\n");
fwrite($fphtml,"Link to Raw JPEG2000 Page Image\n");
fwrite($fphtml,"</th>\n");
fwrite($fphtml,"<th>\n");
...
while (!feof($fp)) {
  ...
  fwrite($fphtml,"</td>\n");
  fwrite($fphtml,"<td>\n");
  fwrite($fphtml,"<a href='http://newspapers.vre.upei.ca/islandora/object/$pid/datastream/JP2/download' target='_blank'>$pid.jp2</a>\n");
  fwrite($fphtml,"</td>\n");
  fwrite($fphtml,"<td>\n");
